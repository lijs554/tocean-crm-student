	...
	<div>
		...
		<div class="content1">
			...
			<el-table :data="data" border style="width: 100%">
				...
				<el-table-column prop="date" label="日期" width="122px">
				</el-table-column>
				<el-table-column prop="startTime" label="开始时间" width="117px">
				</el-table-column>
				<el-table-column prop="endTime" label="结束时间" width="136px">
				</el-table-column>
